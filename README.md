...
<Variable name="keycolor" description="Main Color" type="color" default="#e5f0ee" hideEditor="true"  value="#ccd9ea"/>
...
<Group description="Body">
  <Variable name="body.background" description="Background" color="$(body.background.color)" type="background" default="$(color) none repeat scroll top left"  value="#ccd9ea url(https://themes.googleusercontent.com/image?id=1PViTUnIUSKDy0JJydtqwXOzvZKG0IIJYN8IFx4v__-n881NSni7O3gGUXyMmHxVs8wah) repeat fixed top center /* Credit: lobaaaato (http://www.istockphoto.com/portfolio/lobaaaato?platform=blogger) */"/>
  <Variable name="body.background.color" description="Body background color" type="color" default="#fff"  value="#FFFFFF"/>
  <Variable name="body.text.font" description="Font" type="font" default="$(loraNormal20)"  value="normal 400 20px Lora, serif"/>
  <Variable name="body.text.color" description="Color" type="color" default="#292929"  value="#122e4d"/>
  <Variable name="body.link.color" description="Link color" type="color" default="#25a186"  value="#2540a1"/>
  <Variable name="body.link.visited.color" description="Visited link color" type="color" default="$(body.link.color)"  value="#2540a1"/>
  <Variable name="body.link.hover.color" description="Link Hover Color" type="color" default="$(body.link.color)"  value="#2540a1"/>
  <Variable name="blog.title.font" description="Blog Title Font" type="font" default="$(openSansBold24)"  value="normal 700 20px Open Sans, sans-serif"/>
...
<Group description="Featured post" selector=".heroPost">
  <Variable name="heropost.main.background.color" description="Featured post main background color" type="color" default="#25a186"  value="#EEEEEE"/>
  <Variable name="heropost.main.title.color" description="Featured post main title color" type="color" default="#fff"  value="#000000"/>
  <Variable name="heropost.main.text.color" description="Featured post main text color" type="color" default="#fff"  value="#23527b"/>
  <Variable name="heropost.main.button.color" description="Featured post main buttons color" type="color" default="#fff"  value="#000000"/>
  <Variable name="heropost.main.link.color" description="Featured post main link color" type="color" default="#173752"  value="#110b28"/>
  <Variable name="heropost.secondary.background.color" description="Featured post background color (secondary)" type="color" default="#e5f0ee"  value="#e4e9ef"/>
  ...
  <Variable name="heropost.secondary.button.color" description="Featured post buttons color (secondary)" type="color" default="#25a186"  value="#ebf0ef"/>
...
<Group description="Header" selector=".centered-top-container">
  ...
  <Variable name="header.description.font" description="Description font" type="font" default="$(openSansNormal14)"  value="normal 400 14px Open Sans, sans-serif"/>
  <Variable name="header.description.color" description="Description Color" type="color" default="rgba(0,0,0,0.54)"  value="#151515"/>
  <Variable name="header.pages.color" description="Page list color" type="color" default="#25a186"  value="#8625a1"/>
  <Variable name="header.pages.selected.color" description="Page list color (selected page)" type="color" default="$(header.pages.color)"  value="#000000"/>
  <Variable name="header.items.color" description="Text color" type="color" default="#25a186"  value="#7B1FA2"/>
  <Variable name="header.items.font" description="Text font" type="font" default="$(openSansSemibold14)"  value="normal bold 12px Open Sans, sans-serif"/>
</Group>

<Group description="Search">
  <Variable name="search.input.font" description="Input font" type="font" default="$(openSansSemibold16)"  value="normal normal 16px Open Sans, sans-serif"/>
</Group>
...
<Group description="Feed" selector=".widget.Blog">
  ...
  <Variable name="feed.title.color" description="Post title color" type="color" default="#25a186"  value="#2540a1"/>
  ...
  <Variable name="feed.button.color" description="Button color" type="color" default="#25a186"  value="#2540a1"/>
</Group>
...
<Group description="Sharing" selector=".sharing">
  ...
  <Variable name="sharing.text.color" description="Sharing text color"
      type="color"
      default="$(feed.button.color)"  value="#2540a1"/>
  <Variable name="sharing.icons.color"
      description="Sharing icons color"
      type="color"
      default="$(sharing.text.color)"  value="#2540a1"/>
</Group>
...
<Group description="Dialogs" selector=".subscribe-popup">
  ...
  <Variable name="dialog.title.color" description="Dialog title color" type="color" default="rgba(0,0,0,0.84)"  value="rgba(0,0,0,0.839)"/>
  ...
  <Variable name="dialog.input.color" description="Dialog input color" type="color" default="rgba(0,0,0,0.84)"  value="rgba(0,0,0,0.839)"/>
  ...
  <Variable name="dialog.action.color" description="Dialog action color" type="color" default="$(feed.button.color)"  value="#2540a1"/>
</Group>

<Group description="Individual Post or Page" selector="body.item-page .widget.Blog">
  <Variable name="item.title.font" description="Font" type="font" default="$(openSansSemibold48)"  value="normal 600 40px Open Sans, sans-serif"/>
  ...
  <Variable name="item.byline.color" description="Post byline color" type="color" default="#25a186"  value="#2540a1"/>
  ...
  <Variable name="item.action.color" description="Action color" type="color" default="#25a186"  value="#122e4d"/>
  <Variable name="item.action.font" description="Action font" type="font" default="$(openSansSemibold14)"  value="normal 600 14px Open Sans, sans-serif"/>
  <Variable name="item.label.font" description="Label font" type="font" default="$(openSansNormal14)"  value="normal 400 14px Open Sans, sans-serif"/>
  <Variable name="item.blockquote.font" description="Blockquote font" type="font" default="$(openSansSemiboldItalic44)"  value="normal bold 14px Open Sans, sans-serif"/>
</Group>
...
<Group description="Sidebar" selector=".sidebar-container">
  ...
  <Variable name="sidebar.profile.link.color" description="Profile link color" type="color" default="$(body.link.color)"  value="#2540a1"/>
</Group>
...
padding-right:$(sidebar.width)
            ...
            <div class='main_header_elements container'>
              ...
              <div class='blog-name'>
                <b:section id='header' name='Header' showaddelement='false'>
                  <b:widget id='Header1' locked='true' title='Akash Book Summary Hindi (हैडर)' type='Header' visible='true'>
                    <b:widget-settings>
              ...
              <b:if cond='data:view.isLayoutMode or data:widgets any (w =&gt; w.sectionId == &quot;search_top&quot;)'>
                <div class='search'>
                  ...
                  <b:section id='search_top' name='Search (Top)' showaddelement='false'>
                    <b:widget id='BlogSearch1' locked='true' title='यह ब्लॉग खोजें' type='BlogSearch' visible='true'>
          ...
          <nav role='navigation'>
            <b:section class='centered-top-secondline' id='page_list_top' name='Page List (Top)' showaddelement='false'>
              <b:widget id='PageList1' locked='true' title='' type='PageList' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='pageListJson'><![CDATA[{"198083810750278807":{"href":"https://www.akashbooksummaryhindi.com/p/about-us.html","position":0,"title":"About Us"},"325452275052961503":{"href":"https://www.akashbooksummaryhindi.com/p/disclaimer.html","position":2,"title":"Disclaimer"},"7214968319025060977":{"href":"https://www.akashbooksummaryhindi.com/p/term-and-conditions.html","position":3,"title":"Term and Conditions"},"5043220307908318941":{"href":"https://www.akashbooksummaryhindi.com/p/contect.html","position":1,"title":"Contect"},"6673727102441083633":{"href":"https://www.akashbooksummaryhindi.com/p/privacy.html","position":4,"title":"Privacy"}}]]></b:widget-setting>
                  <b:widget-setting name='homeTitle'>म&#2369;ख&#2381;यप&#2371;ष&#2381;ठ</b:widget-setting>
                </b:widget-settings>
                <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
              ...
              <div class='centered'>
                <main class='centered-bottom' id='main' role='main' tabindex='-1'>
                  ...
                  <b:section class='main' id='page_body' name='Page Body' showaddelement='false'>
                    <b:widget id='FeaturedPost1' locked='true' title='Menu' type='FeaturedPost' version='2' visible='false'>
                      <b:widget-settings>
  ...
  <b:if cond='data:post.title != &quot;&quot;'>
    <h3 class='post-title'><a expr:href='data:post.url'><data:post.title/></a></h3>
            ...
            <b:include cond='data:posts.any' data='{                                postDisplay: data:postDisplay,                                post: data:posts.first                              }' name='heroPost'/>
                    ...
                    <b:widget id='Blog1' locked='true' title='ब्लॉग संदेश' type='Blog' version='2' visible='true'>
                      <b:widget-settings>
                        ...
                        <b:widget-setting name='postLocationLabel'>Location:MP India</b:widget-setting>
 ...
 &quot;publisher&quot;: {
    ...
    <b:if cond='data:showCmtPopup'>
      <div id='comment-popup'>
        <iframe allowtransparency='allowtransparency' frameborder='0' id='comment-actions' name='comment-actions' scrolling='no'>
                    ...
                    <b:widget cond='data:view.isSingleItem and data:posts any (p =&gt; p.id != data:view.postId)' id='PopularPosts1' locked='true' title='लोकप्रिय लेख' type='PopularPosts' version='2' visible='true'>
                      <b:widget-settings>
      ...
      <article class='post' role='article'>
        ...
        <aside class='sidebar-container sidebar-invisible' role='complementary'>
          ...
          <b:section class='sidebar' id='sidebar' name='Sidebar' preferred='yes'>
            <b:widget id='Profile1' locked='false' title='मेरे बारे में' type='Profile' visible='true'>
              <b:widget-settings>
  ...
  <script src='//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit'/>
            ...
            <b:widget id='Label1' locked='false' title='लेबल' type='Label' visible='true'>
              <b:widget-settings>
  ...
  <div class='widget-content'>
    ...
    <b:include cond='data:this.display == &quot;cloud&quot;' name='cloud'/>
          ...
          <b:include data='{                               buttonClass: &quot;flat-button&quot;,                               items: data:this.labels,                               itemSet: &quot;labels&quot;,                               itemsMarkup: &quot;super.list&quot;                             }' name='extendableItems'/>
            ...
            <b:widget id='PageList2' locked='false' title='पेज' type='PageList' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='pageListJson'><![CDATA[{"198083810750278807":{"href":"https://www.akashbooksummaryhindi.com/p/about-us.html","position":0,"title":"About Us"},"325452275052961503":{"href":"https://www.akashbooksummaryhindi.com/p/disclaimer.html","position":2,"title":"Disclaimer"},"7214968319025060977":{"href":"https://www.akashbooksummaryhindi.com/p/term-and-conditions.html","position":4,"title":"Term and Conditions"},"5043220307908318941":{"href":"https://www.akashbooksummaryhindi.com/p/contect.html","position":1,"title":"Contect"},"6673727102441083633":{"href":"https://www.akashbooksummaryhindi.com/p/privacy.html","position":3,"title":"Privacy"}}]]></b:widget-setting>
                <b:widget-setting name='homeTitle'>म&#2369;ख&#2381;यप&#2371;ष&#2381;ठ</b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
  <b:include name='widget-title'/>
  ...
  <ul>
    ...
    <b:loop values='data:links' var='link'>
      <b:include name='pageLink'/>
            ...
            <b:widget id='Followers1' locked='false' title='फ़ॉलोअर' type='Followers' visible='false'>
              <b:widget-settings>
                ...
                <b:widget-setting name='endcapTextColor'>#122e4d</b:widget-setting>
                <b:widget-setting name='contentTextColor'>#122e4d</b:widget-setting>
                <b:widget-setting name='contentSecondaryLinkColor'>#FFFFFF</b:widget-setting>
                <b:widget-setting name='endcapLinkColor'>#2540a1</b:widget-setting>
                <b:widget-setting name='contentLinkColor'>#2540a1</b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
  ...
  <div class='widget-content'>
    ...
    <b:include name='quickedit'/>
            ...
            <b:widget id='BlogArchive1' locked='false' title='Post' type='BlogArchive' visible='false'>
              <b:widget-settings>
  ...
  <b:include name='reportAbuse'/>
      ...
      <b:section class='footer' id='footer' name='Footer' showaddelement='false' tag='footer'>
        <b:widget id='Attribution1' locked='true' title='' type='Attribution' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='copyright'>Copyright By Akash Book Summary Hindi</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main' var='this'>
  <div class='widget-content'>
    <div class='blogger'>
